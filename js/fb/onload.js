...
var Book_v5 = {
			...
			when: {
				...
				turned: function(e, page) {
					...
					if ( page < $(this).turn('pages') ) {
						...
						$('.fb5-nav-arrow-ext-right').fadeIn();
					}
	...
	arrows: function() {
		...
		// left
		$('.fb5-nav-arrow-ext-left.add').click(function() {
			alert("left add");
		});		
		$('.fb5-nav-arrow-ext-left.edit').click(function() {
			alert("left eidt");
		});
		$('.fb5-nav-arrow-ext-left.del').click(function() {
			alert("left del");
		});
		
		$('.fb5-nav-arrow-ext-left.move').click(function() {
			alert("left move");
		});
		...
		$('.fb5-nav-arrow-ext-right.edit').click(function() {
			alert("right eidt");
		});
		$('.fb5-nav-arrow-ext-right.del').click(function() {
			alert("right del");
		});
		
		$('.fb5-nav-arrow-ext-right.move').click(function() {
			alert("right move");
		});
    ...
    scale_arrows:function(){
       ...
       this.zoom_arrows=height_arrow/HEIGHT_ARROW;   
		...
		$('.fb5-nav-arrow-ext-left').css({'transform':'scale('+this.zoom_arrows+')','-ms-transform':'scale('+this.zoom_arrows+')','-webkit-transform':'scale('+this.zoom_arrows+')'}); 	

		$('.fb5-nav-arrow-ext-right').css({'transform':'scale('+this.zoom_arrows+')','-ms-transform':'scale('+this.zoom_arrows+')','-webkit-transform':'scale('+this.zoom_arrows+')'}); 						
    },
