...
final class Mage {
	 ...
	 * @var bool
	 */
	private static $_isDownloader = false;
	...
	public static function register($key, $value, $graceful = false) {
		// echo "key: ".$key.", value: ".$value.", graceful: ".$graceful."<br>";
	 ...
	 *
	 * @param string $key
	 *        	optional, if specified will load this key
	...
	public static function helper($name) {
		...
		if (! self::registry ( $registryKey )) {
			...
			// echo "class: ".$helperClass.", name: ".$name."<br>";
	...
	public static function run($code = '', $type = 'store', $options = array()) {
		try {
			...
			try {
				self::dispatchEvent ( 'mage_run_exception', array (
						'exception' => $e 
				) );
