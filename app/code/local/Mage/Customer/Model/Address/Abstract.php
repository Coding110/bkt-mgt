...
public function getCity()
    ...
    public function getCityModel($city=null)
    {
    	...
    	if(!isset(self::$_cityModels[$city])) {
    		self::$_cityModels[$city] = Mage::getModel('wangdz_directoryex/city')->load($city);
    	}
    ...
    public function getDistrictModel($district=null)
    {
    	...
    	if(!isset(self::$_districtModels[$district])) {
    		self::$_districtModels[$district] = Mage::getModel('wangdz_directoryex/district')->load($district);
    	}
