<?php
class Wangdz_Directoryex_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	public function getCityCollection()
    {
        if (!$this->_cityCollection) {
            $this->_cityCollection = Mage::getModel('wangdz_directoryex/city')->getResourceCollection();
        }
    ...
    public function getCityJson()
    {
        ...
        if (!$this->_cityJson) {
            ...
            if (empty($json)) {
                ...
                $collection = Mage::getModel('wangdz_directoryex/city')->getResourceCollection()
    ...
    public function getDistrictJson()
    {
        ...
        if (!$this->_districtJson) {
            ...
            if (empty($json)) {
                ...
                $collection = Mage::getModel('wangdz_directoryex/district')->getResourceCollection()
