<?php
class Wangdz_Directoryex_Model_Resource_District extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('wangdz_directoryex/country_district', 'district_id');
    ...
    public function loadById(Wangdz_Directoryex_Model_District $district, $districtId, $cityId)
    {
        return $this->_loadByCity($district, $cityId, (int)$districtId, 'district_id');
    }

    public function loadByName(Wangdz_Directoryex_Model_District $district, $districtName, $cityId)
    {
