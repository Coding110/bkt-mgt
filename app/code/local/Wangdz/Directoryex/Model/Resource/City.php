<?php
class Wangdz_Directoryex_Model_Resource_City extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('wangdz_directoryex/country_city', 'city_id');
        $this->_cityNameTable = $this->getTable('wangdz_directoryex/country_city_name');
    }
    ...
    public function loadById(Wangdz_Directoryex_Model_City $city, $cityId, $regionId)
    {
        return $this->_loadByRegion($city, $regionId, (int)$cityId, 'city_id');
    }

    public function loadByName(Wangdz_Directoryex_Model_City $city, $cityName, $regionId)
    {
