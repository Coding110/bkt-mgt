<?php
class Wangdz_Directoryex_Model_Resource_City_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    public function toOptionArray()
    {
    	...
    	if (count($options) > 0) {
    		...
    		'title '=> null,
    		'value' => '0',
    		'label' => Mage::helper('directoryex')->__('-- Please select --')
    		));
    	}
    	return $options;
    }
